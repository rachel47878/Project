...
public class EmployeeTraining{
        ...
        int i = 0;
        final String DATABASE_URL = "jdbc:mysql://localhost:3306/hrsystem";

        // Create a training module for employees
        public void setTraining(int employeeId, int courseId, String assignedBy, String dueDate){
        ...
        public void updateTraining(int employeeId, int courseId, String assignedBy, String dueDate){
